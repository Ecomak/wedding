...
<section id="location" className="text-center scroll-mt-24">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
    ...
    <div className="md:col-span-2 flex justify-center">
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between text-left w-full max-w-md">
        <div>
          <h3 className="text-xl font-bold text-gray-800 mb-2">
            {t.venueWinterthurTitle}
          </h3>
          <p className="text-gray-500 mb-6 text-sm">
            {t.venueWinterthurAddress}
          </p>
        </div>
